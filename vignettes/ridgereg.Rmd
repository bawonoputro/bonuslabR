...
qr_demo_result <- tryCatch({
  ...
  # fit final QR-based ridge on all training data
  ...
  # evaluate QR-based ridge on train and test
  ...
  list(
    best_lambda_qr     = best_lambda_qr,
    ridge_train_rmse_qr = ridge_train_rmse_qr,
    ridge_test_rmse_qr  = ridge_test_rmse_qr
  )

}, error = function(e) {
  message("Skipping QR ridge demo in vignette due to error: ", e$message)
  NULL
})
...
if (requireNamespace("caret", quietly = TRUE)) {
  ...
  message("Package 'caret' not installed; skipping caret::train() demo.")
}
